...
class ShopSettings extends React.Component {
  ...
  render() {
    ...
    return <React.Fragment>
      ...
      {this.state.displaySearchImage ? <SearchImage name="coverImgUrl" data-category="style" handleSettingChange={props.handleSettingChange} toggleSearchImage={this.toggleSearchImage} /> : null}
      <div className='modal-settings'>
        <div className="content">
          ...
          <div class="field">
            <input type="file" id="logoUrl" name="logoUrl" data-category="style" onChange={props.handleSettingChange} />
            <label for="logoUrl">Logo</label>
          </div>

          <div class="field">
            <input type="text" id="field-value" className="field-value" name="name" value={props.shop.info.name} data-category="info" onChange={props.handleSettingChange} />
            <label for="field-value">Name</label>
          </div>


          <div class="field">
            <input type="text" id="description" name="description" value={props.shop.info.description} data-category="info" onChange={props.handleSettingChange} />
            <label for="description">Slogan</label>
          </div>

          {/* <input type="text" onChange={props.handleSettingChange} /> */}
          <div class="field">
            <input name="imgs" className="uploadImg" name="coverImgUpload" data-category="style" onChange={props.handleSettingChange} type="file" />
          ...
          <div class="field">
            <input type="text" id="videoUrl" name="videoUrl" value={props.shop.style.videoUrl} data-category="style" onChange={props.handleSettingChange} />
            <label className="logo" for="videoUrl"><img src={YoutubeIcon} alt="icon" /></label>
          </div>

          <div class="field">
            <input type="text" id="instagram" name="instagram" value={props.shop.info.instagram} data-category="info" onChange={props.handleSettingChange} />
            <label className="logo" for="instagram"><img src={InstgaramIcon} alt="icon" /></label>
          </div>

          <div class="field">
            <input id="facebook" type="text" name="facebook" value={props.shop.info.facebook} data-category="info" onChange={props.handleSettingChange} />
